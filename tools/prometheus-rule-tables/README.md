...
```sh
python3 tools/prometheus-rule-tables/generate_rule_tables.py \
  --repo ../ska-mid-cbf-fhs-prometheus-exporter \
  -o tools/prometheus-rule-tables/rules.md
```
...
```sh
# Markdown on stdout
python3 tools/prometheus-rule-tables/generate_rule_tables.py --repo /path/to/exporter
