...
if kx "test -f /tmp/real/deployments/air-gapped-mirror/chart/Chart.yaml && \
       test -f /tmp/real/deployments/air-gapped-mirror/sync-job/mirror_sync/sync.py && \
       test -f /tmp/real/tools/netbox/csv-import/netbox_import/sync.py"; then
